          ...
          fluidRow(
            ...
            column(width = 10,
              ...
              fluidRow(
                ...
                column(width = 2,
                  numericInput("year_from", label = div(icon("filter"), span("Year from")),
                               min = FIRST_YEAR, max = LAST_YEAR,
                               value = LAST_YEAR)
                ),
                column(width = 2,
                  numericInput("year_to", label = div(icon("filter"), span("Year to")),
                               min = FIRST_YEAR, max = LAST_YEAR,
                               value = LAST_YEAR)
                ),
                column(width = 2,
